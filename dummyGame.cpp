...
void Game::play(){
	...
	while(input != "exit"){
		if(input == "talk up"){
			...
			// pemain.grow(peta[pemain.getPosisiX()-1][pemain.getPosisiY()]);
		} else if(input == "well up"){
            // if(isInRange(pemain.getPosisiX()-1,pemain.getPosisiY())){
            //     if (typeid(Well) == typeid(&peta[pemain.getPosisiX()-1][pemain.getPosisiY()])){
            //         pemain.interact(&peta[pemain.getPosisiX()-1][pemain.getPosisiY()],"");
            //     }
            // }
